...
export const categories: Category[] = [
  { id: 'remises-offres', name: 'Remises et Offres', icon: 'percent' },
  { id: 'scotch', name: 'Scotch', icon: 'tape' },
  { id: 'droguerie', name: 'Droguerie', icon: 'wrench' },
  { id: 'sanitaire', name: 'Sanitaire', icon: 'droplet' },
...
export const cities: City[] = [
  ...
  { id: "aitMelloul", name: "Aït Melloul" },
  { id: "asilah", name: "Asilah" },
  { id: "fnideq", name: "Fnideq" },
  { id: "saidia", name: "Saïdia" },
  { id: "azemmour", name: "Azemmour" },
  { id: "inezgane", name: "Inezgane" },
  { id: "laayoune", name: "Laâyoune" },
  { id: "alhoceima", name: "Al Hoceïma" },
  { id: "martil", name: "Martil" },
  { id: "mdiq", name: "M'diq" },
  { id: "skhirat", name: "Skhirat" },
  { id: "temara", name: "Témara" }
];
